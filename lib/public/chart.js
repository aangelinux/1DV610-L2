...
export class Chart {
    ...
    /**
     * Validates a data object for its types and value ranges.
     * 
     * @param {Array} data containing objects with data.
    ...
    /**
     * Validates an options object for its types and value ranges.
     * 
     * @param {object} options containing chart style information.
     * @throws {Error} if any validation checks fail.
     */
    ...
    /**
     * Removes the chart's static CSS template and replaces it with another.
     * 
