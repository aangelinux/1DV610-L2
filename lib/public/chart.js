...
export class Chart {
    ...
    createBarChart(data, options = this.#config.defaultGraphOptions) {
        ...
        return new BarChart(this.#chart, data, options).set(dependencies).render()
    }
    ...
    createLineGraph(data, options = this.#config.defaultGraphOptions) {
        ...
        return new LineGraph(this.#chart, data, options).set(dependencies).render()
    }
    ...
    createPieChart(data, options = this.#config.defaultPieOptions) {
        ...
        return new PieChart(this.#chart, data, options).set(dependencies).render()
    }
