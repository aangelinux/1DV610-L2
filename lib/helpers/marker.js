...
export class Marker {
    ...
    _renderBars(data) {
        ...
        data.forEach((object) => {
            ...
            const bar = this.#createBar(wrapperWidth, object.number)
    ...
    #createBar(wrapperWidth, dataValue) {
        const chartHeightScale = this.#chart.getAttribute("height") / this.#heightRatio // TODO Move this?
