...
export class Scale {
    ...
    #createArrayFrom(startValue, maxValue) {
        ...
        // Temp solution, remove value 0 because otherwise 5 rows will be rendered instead of 4
        yAxisValues.shift()
        return yAxisValues
    }
    ...
    #getEndCoordinates(startCoordinates, centerCoordinates, angle, radius) { // TODO too many params
