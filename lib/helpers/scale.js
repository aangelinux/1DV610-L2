...
export class Scale {
    ...
    _getPieSlices(dataDecimals, startCoordinates, centerCoordinates, radius) {
        let currentCoordinates = startCoordinates
        let pieSlices = []

        dataDecimals.forEach((dataObject) => {  // TODO extract into separate method
            const startAngle = this.#calculateStartAngle(currentCoordinates, centerCoordinates)
            ...
            const endCoordinates = this.#calculateEndCoordinates(centerCoordinates, radius, endAngle)
