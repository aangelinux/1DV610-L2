...
export class Axis {
    ...
    _renderYAxis (values) {
        ...
        const pointDistance = this.#chart.getAttribute("height") / this.#yAxisPoints  // Extract to Scale
    ...
    #createYAxis() {
        ...
        yAxis.style.height = `${this.#chart.getAttribute("height")}px`  // Extract to Style
    ...
    #createYAxisPoint(pointDistance) {  // TODO Change 'point' name to something clearer
        ...
        point.style.width = `${this.#chart.getAttribute("width")}px`  // Extract to Style
    ...
    _renderXAxis (values) {
        ...
        const pointDistance = this.#chart.getAttribute("width") / (values.length - 1)  // Extract to Scale
    ...
    #createXAxis() {
        ...
        xAxis.style.width = `${this.#chart.getAttribute("width")}px`  // Extract to Style
