...
export class Validator {
    ...
    #validateOptionValues(options) {
        ...
        this.#validateRangeOf(chartWidthValue, this.#optionsKeysValues["chartWidth"])

        const chartHeightValue = options["chartHeight"]
        this.#validateRangeOf(chartHeightValue, this.#optionsKeysValues["chartHeight"])
    }
