...
export class Validator {
    ...
    #dataSecondKeyValue = { min: 0, max: 10000000 } // TODO add separate values for different charts
    #optionsKeys = { min: 3, max: 5 }
    #optionsKeysValues = {
        width: { min: 200, max: 1000 },
        height: { min: 150, max: 800 },
        radius: { min: 100, max: 400 },
        color: ["darkred", "red", "orange", "yellow", "green", "blue", "indigo", "violet", "darkolivegreen"],
        font: ["monaco, monospace", "arial", "verdana", "tahoma", "times new roman", "georgia", "lexend light"]
    }
