...
export class Validator {
    ...
    #optionsKeysValues = {
        ...
        color: ["darkred", "red", "orange", "yellow", "green", "blue", "violet", "indigo", "violet"],
        font: ["monaco, monospace", "arial", "verdana", "tahoma", "times new roman", "georgia"]
    }

    #optionsColors = ["darkred", "red", "orange", "yellow", "green", "blue", "violet", "indigo", "violet"]
    #optionsFonts = ["monaco, monospace", "arial", "verdana", "tahoma", "times new roman", "georgia"]
        ...
        for (const key in this.#optionsKeysValues) {
            ...
            if (matchingKey) {
                if (matchingKey === "color" || matchingKey === "font") {
                    this.#validateStringOf(options[matchingKey].toLowerCase(), this.#optionsKeysValues[matchingKey])
                } else {
